...
export default function CodeArea({ userInput, setUserInput }) {
    return (
        <>
            <div className=" min-h-[80px] w-full rounded-md border border-black hover:shadow-none shadow-[4px_4px_0px_0px_black] transition focus:outline-none focus:shadow-xs">
                <textarea
                    value={userInput || ""}
