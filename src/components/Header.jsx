...
export default function Header() {
  ...
  return (
    <>
      <header className="inset-0 backdrop-blur-lg border text-black bg-white/90  dark:text-white dark:bg-black border-black shadow-white/15 shadow-sm transition focus:shadow-xs focus:outline-none">
        <div className="flex inset-0 backdrop-blur-lg h-16 w-full items-center justify-between px-4 md:px-8 lg:px-64 py-2">
          ...
          <div className="flex items-center gap-2">
            <h1 className="text-sm">
              ...
              <a className="underline" href="https://faizshaikh.vercel.app/" target="_blank" rel="noopener noreferrer">
                Faiz
              </a>
            </h1>
